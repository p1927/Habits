...
export function AgentSectionOverlays(p: { voiceOpen: boolean; onVoiceOpenChange: (o: boolean) => void; onVoiceStatusChange: (s: VoiceIframeStatus | null) => void; toolsOpen: boolean; onToolsOpenChange: (o: boolean) => void; onSelectToolPrompt: (t: string) => void; toolsLoading?: boolean; attachOpen: boolean; onAttachOpenChange: (o: boolean) => void; cameraOpen: boolean; onCameraOpenChange: (o: boolean) => void; recentPhotos: MealPhoto[]; onPickImage: (d: string, l?: string) => void; onCapture: (d: string) => void; serverOnline: boolean; scanning: boolean }) {
