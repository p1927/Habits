...
export function useHomeSection({
  ...
  return {
    ...
    ringSharePreviewUrl: dashboard.ringSharePreviewUrl,
    closeRingShareSheet: dashboard.closeRingShareSheet,
    downloadRingShareFromSheet: dashboard.downloadRingShareFromSheet,
